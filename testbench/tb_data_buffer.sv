...
module tb_data_buffer ();
    ...
    logic clk, n_rst, input_write, input_read, output_read, weight_write, weight_read, done;
    ...
    initial begin
        ...
        reset_dut;
        // Testing 8 writes and 8 reads for input. It takes 23 cycles to read 8 things out
        ...
        // @(negedge clk);
        // @(negedge clk);
       // Testing writing and reading 8 weights. It takes 23 cycles to read things out
