    ...
    initial begin
        ...
        test_name = "Writing 8 outputs, then starting inference";
          ...
          writepls(10'd8, 64'hAAAAAAAAAAAAAAAA);
           writepls(10'd8, 64'hDDDDDDDDDDDDDDDD);
           writepls(10'd8, 64'hCCCCCCCCCCCCCCCC);
           writepls(10'd8, 64'h7777777777777777);
           writepls(10'd8, 64'h8888888888888888);
           writepls(10'd8, 64'h9999999999999999);
          @(posedge clk);
          start_inference = 1;
          @(posedge clk);
          start_inference = 0;
        ...
        @(negedge clk);
        activations = 64'h3333333333333333;
        @(negedge clk);
        activations = 64'h4444444444444444;
        @(negedge clk);
        activations = 64'h5555555555555555;
        @(negedge clk);
        activations = 64'h6666666666666666;
        @(negedge clk);
        activations = 64'h7777777777777777;
        @(negedge clk);
        activations = 64'h8888888888888888;
        @(negedge clk);
        @(negedge clk);
        @(negedge clk);
        @(negedge clk);
